...
info: A software development framework for deciding where to reduce variance and where to permit it to enable creativity.
fonts:
  sans: IBM Plex Sans
...
<div class="grid grid-cols-[1.2fr_1fr] gap-10 mt-10">
  <div>
    <div class="text-2xl font-700 leading-tight">
      Most LLM discussion put too much value on prompting.
    </div>
    <div class="mt-6 text-lg opacity-85 leading-relaxed">
      Better prompts help, but they are not the main lever for reliable results.
    </div>
  </div>
  <div class="rounded-2xl border border-white/15 bg-white/6 p-6">
    ...
    <div class="mt-4 text-xl leading-snug">
      There are four factors, that when managed well produce reliable results from an LLM.
    </div>
  </div>
</div>
...
<div class="mt-5 rounded-2xl border border-white/15 bg-white/5 p-6">
  <div class="flex items-center gap-3 text-sm uppercase tracking-widest opacity-65">
    <span>High Permitted Variance</span>
    <span class="opacity-40">→</span>
    <span>Medium</span>
    <span class="opacity-40">→</span>
    <span>Low</span>
    <span class="opacity-40">→</span>
    <span>No Permitted Variance</span>
  </div>
...
<div class="grid grid-cols-2 gap-8 mt-8 text-lg">
  <div>
    <div class="font-700">High permitted variance</div>
    <div class="mt-2 opacity-80">Variance is intentionally permitted. Many valid outputs may exist, creating room for creativity.</div>
    <div class="mt-5 font-700">Medium permitted variance</div>
    <div class="mt-2 opacity-80">Variance is intentionally bounded. Judgment and creativity are allowed inside visible limits.</div>
  </div>
  <div>
    <div class="font-700">Low permitted variance</div>
    <div class="mt-2 opacity-80">Variance is intentionally reduced. Most work should conform to existing constraints.</div>
    <div class="mt-5 font-700">No permitted variance</div>
    <div class="mt-2 opacity-80">Variance is intentionally minimized. Strict adherence or binary verification.</div>
  </div>
</div>

<div class="mt-8 text-xl font-600 text-amber-300">
Invest effort to reduce variance where it is costly. Permit variance where it is useful.
</div>
...
<div class="mt-2 text-sm uppercase tracking-widest opacity-60">Definition vs Execution Permitted Variance by Factor</div>
...
const methodologyToggleRows: MethodologyToggleRow[] = [
  ...
  },
  {
    ...
    outcome: 'Fast-feeling execution with high permitted variance and uneven validation quality.',
  },
  {
  ...
  },
  {
    ...
    outcome: 'High repeatability by permitting creativity in system design while reducing runtime variance.',
  },
  {
...
Methods differ less by prompting style and more by where they reduce or permit variance in definition and execution across the four factors.
</div>
...
<div class="mt-4 text-sm uppercase tracking-widest opacity-60">Where do methods reduce vs permit variance?</div>

| Method | Shape | Typical Tradeoff |
| --- | --- | --- |
| Traditional Development | More structure up front | Reliable, but slower to define |
| Vibe Coding | Minimal structure, high permitted variance | Fast feeling, high permitted variance |
...
Methodologies differ mostly in where they permit variance and where they reduce it through strictness.
</div>
...
<div class="mt-1 text-2xl font-700">Medium Permitted Variance</div>
<div class="mt-2 text-base leading-relaxed opacity-82">
  Designing constraints requires judgment about process, risk, and how much variance to reduce versus permit.
</div>

<div class="mt-5 text-xs uppercase tracking-widest text-amber-300 opacity-85">Execution Phase</div>
<div class="mt-1 text-2xl font-700">Low Permitted Variance</div>
<div class="mt-2 text-base leading-relaxed opacity-82">
...
No Permitted Variance

This is where variance is most expensive and should be reduced as much as possible. Success should be binary and deterministically verifiable.
...
Software teams get the most leverage by being selective about where they reduce variance and where they intentionally permit it.
</div>
...
<div class="mt-4 grid grid-cols-2 gap-4 items-stretch">
  ...
  <div class="rounded-2xl border border-cyan-400/25 bg-cyan-500/8 p-4">
    ...
    <div class="mt-2 text-xl font-700 leading-tight">Not taking advantage of AI enough</div>
    <div class="mt-3 text-sm leading-relaxed opacity-80">
...
<div class="mt-4 rounded-2xl border border-amber-400/30 bg-amber-500/12 p-4">
  ...
  <div class="mt-3 text-sm leading-relaxed opacity-85">
    Not maximum control, nor maximum speed. Enough structure to protect what matters without specifying so much that you lose the speed benefit.
  </div>
</div>
...
<div class="mt-5 grid grid-cols-3 gap-4 items-stretch">
  ...
  <div class="rounded-2xl border border-cyan-400/20 bg-cyan-500/8 p-4">
    ...
    <div class="mt-3 text-sm leading-relaxed opacity-80">
      Higher-risk or more repeatable projects can justify more constraints. Exploratory projects need fewer.
    </div>
  </div>
  ...
  <div class="rounded-2xl border border-pink-400/20 bg-pink-500/8 p-4">
    ...
    <div class="mt-2 text-lg font-700 leading-tight">A codebase will move along the range.</div>
    <div class="mt-3 text-sm leading-relaxed opacity-80">
      Early exploration may intentionally permit more variance. Later implementation and validation will need tighter control.
    </div>
  </div>
</div>

<div class="mt-5 text-lg opacity-82 leading-relaxed max-w-5xl">
  The right balance is situational. The job is not to find one perfect setting, but to choose a balance for the task at hand.
</div>
...
<div class="mt-8 grid grid-cols-[1.2fr_1fr] gap-8">
  <div>
    <ol class="space-y-4 text-xl leading-relaxed">
      ...
      <li>Define <span class="text-pink-300 font-700">direction</span> with enough permitted variance to choose the right path.</li>
  ...
  <div class="rounded-2xl border border-white/15 bg-white/6 p-6">
    ...
    <div class="mt-4 text-2xl leading-snug font-700">
      LLMs work better when boundaries are deterministic, not when prompts simply demand more.
    </div>
  </div>
</div>
...
<div class="mt-8 space-y-6 max-w-5xl">
  ...
  <div class="text-3xl leading-tight font-700 text-pink-300">
    Reduce variance where it is costly, and permit it where it is useful for creativity.
  </div>
</div>
